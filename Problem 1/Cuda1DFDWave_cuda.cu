...
void cudaCallDisplacementKernel(const unsigned int blocks, const unsigned int threadsPerBlock, const float *old_d, const float *current_d, float *new_d, float size float courant){
